...
public abstract class Order
{
    ...
    private static void matchOrders(long assetId)
    {
        ...
        while ((askOrder = Ask.getNextOrder(assetId)) != null && (bidOrder = Bid.getNextOrder(assetId)) != null)
        {
            ...
            askAccount.addToBalanceAndUnconfirmedBalanceNQT(
            ...
            bidAccount.addToUnconfirmedBalanceNQT(
                    Convert.safeMultiply(trade.getQuantityQNT(), (bidOrder.getPriceNQT() - trade.getPriceNQT())));
    ...
    {
        return getClass().getSimpleName() + " id: " + Convert.toUnsignedLong(id) + " account: "
                + Convert.toUnsignedLong(accountId) + " asset: " + Convert.toUnsignedLong(assetId) + " price: "
                + priceNQT + " quantity: " + quantityQNT + " height: " + creationHeight;
    }
    ...
    public static final class Ask extends Order
    {
        ...
        private static final VersionedEntityDbTable<Ask> askOrderTable = new VersionedEntityDbTable<Ask>("ask_order",
        ...
        public static DbIterator<Ask> getAskOrdersByAccountAsset(final long accountId, final long assetId, int from,
                int to)
        {
        ...
        private void updateQuantityQNT(long quantityQNT)
        {
            ...
            else
            {
                throw new IllegalArgumentException(
                        "Negative quantity: " + quantityQNT + " for order: " + Convert.toUnsignedLong(getId()));
            }
        }
    ...
    public static final class Bid extends Order
    {
        ...
        private static final VersionedEntityDbTable<Bid> bidOrderTable = new VersionedEntityDbTable<Bid>("bid_order",
        ...
        public static DbIterator<Bid> getBidOrdersByAccountAsset(final long accountId, final long assetId, int from,
                int to)
        {
            DbClause dbClause = new DbClause(" account_id = ? AND asset_id = ? ")
            {
