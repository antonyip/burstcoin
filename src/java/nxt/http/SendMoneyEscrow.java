...
public final class SendMoneyEscrow extends CreateTransaction
{
    ...
    {
        super(new APITag[]
        { APITag.TRANSACTIONS, APITag.CREATE_TRANSACTION }, "recipient", "amountNQT", "escrowDeadline",
                "deadlineAction", "requiredSigners", "signers");
    }
    ...
    JSONStreamAware processRequest(HttpServletRequest req) throws NxtException
    {
        ...
        Attachment.AdvancedPaymentEscrowCreation attachment = new Attachment.AdvancedPaymentEscrowCreation(amountNQT,
                deadline.intValue(), deadlineAction, requiredSigners.intValue(), signers);
